...
private:
    ...
    void* m_data;
    bool m_dataAlloc;  // is the buffer in assign was allocated here beforehand
    unsigned int m_length;
...
protected:
     ...
     */
    Thread(const char *name = 0, Priority prio = Normal, unsigned int killOrder = 0);
     ...
     */
    Thread(const char *name, const char* prio, unsigned int killOrder = 0);
